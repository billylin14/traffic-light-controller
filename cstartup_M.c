...
extern void GPIO_J_Handler( void );
...
const intvec_elem __vector_table[] =
{
  ...
  0,
  0,
  GPIO_J_Handler    //67: corresponds to the vector # on p116
...
//timer1 interrupt ISR vector #37, interrupt #21
#pragma call_graph_root = "interrupt"
__weak void Timer1A_Handler ( void ) { while (1) {} }

//GPIO interrupt ISR
#pragma call_graph_root = "interrupt"
__weak void GPIO_J_Handler ( void ) { while (1) {} }

//ADC0 interrupt ISR (vector # 33, interrupt #17)
#pragma call_graph_root = "interrupt"
